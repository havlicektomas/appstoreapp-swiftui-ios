...
//  SwiftUIAppStore
//
//  Created by Tomas Havlicek on 10.07.2021.
//
                ...
                ScrollView {
                    VStack(alignment: .leading) {
                        Image(uiImage: self.image)
                            ...
                            .cornerRadius(15)
                            .overlay(
                                ArticleExcerptView(category: self.category, headline: self.headline, subHeadline: self.subHeadline, isShowContent: self.$isShowContent) .cornerRadius(self.isShowContent ? 0 : 15)
                            )
                            // Content
...
struct ArticleCardView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            ArticleCardView(category: sampleArticles[1].category,
                headline: sampleArticles[1].headline,
                subHeadline: sampleArticles[1].subHeadline,
                image: sampleArticles[1].image,
                content: sampleArticles[1].content, isShowContent: .constant(false))
            ...
            ArticleCardView(category: sampleArticles[0].category,
                ...
                content: sampleArticles[0].content, isShowContent: .constant(true))
